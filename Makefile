...
STUDENT_IMPL_FILE 	= game.cpp
STUDENT_OBJ_FILE 	= game.o
PRIMARY_HEADER_FILE 	= game.hpp
UNIT_TEST_IMPL_FILE 	= game_driver.cpp
UNIT_TEST_OBJ_FILE 	= game_driver.o
UNIT_TEST_BINARY 	= game_driver
